...
import json
from .file_utils import load_json_data, load_multiple_json_files
from ..config.config import get_chunked_data_paths
...
class EnhancedDataProcessor:
    """내부 법령 참조를 활용한 향상된 데이터 처리기 (LangChain 표준)"""
    ...
    def __init__(self, 
        ...
        Args:
            embedder (Optional[LangChainEmbedder]): 임베딩 생성기
            vector_store (Optional[LangChainVectorStore]): 벡터 저장소
