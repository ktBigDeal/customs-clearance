      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2">통관 관련 서비스</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2">부가 서비스</h3>
                  <ul className="space-y-1 text-sm">
                    <li>• AI 챗봇 상담서비스</li>
                    <li>• 통관 가이드 및 FAQ</li>
                    <li>• 관세율 정보 제공</li>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제6조 (서비스 이용시간)</h2>
              <p className="mb-4">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                <h3 className="font-semibold mb-2 text-yellow-800">서비스 중단 시간</h3>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제8조 (관세청의 의무)</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제10조 (회원탈퇴 및 자격상실)</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">제11조 (손해배상 및 면책조항)</h2>
              <p className="mb-4">
              ...
              <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                <h3 className="font-semibold mb-2 text-red-800">면책사항</h3>
